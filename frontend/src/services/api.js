...
export const endpoints = {
  ...
  adminServiceLocations: () => api.get('/admin/service-locations'),
  createServiceLocation: (payload) => api.post('/admin/service-locations', payload),
  updateServiceLocation: (id, payload) => api.put(`/admin/service-locations/${id}`, payload),
  deleteServiceLocation: (id) => api.delete(`/admin/geo/service-locations/${id}`),
